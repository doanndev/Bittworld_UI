...
const Header = () => {
    ...
    return (
        <>
            ...
            <header 
                className="sticky top-2 md:top-4 mx-4 md:mx-6 lg:mx-8 2xl:mx-12 backdrop-blur-xl transition-all duration-300 relative rounded-xl md:rounded-2xl" 
                style={{ 
                    zIndex: 55,
            ...
            >
                ...
                />
                <div className='flex items-center justify-between px-4 md:px-6 2xl:px-12 py-3 md:py-4 2xl:py-5 relative z-10'>
                    {/* Left section: Logo */}
                    <div className='flex items-center flex-shrink-0'>
                        <Link href={defaultAddress} className="flex items-center">
                            <img
                                ...
                                alt="logo"
                                className="h-7 xl:h-9 block dark:hidden"
                            />
                            <img
                                src="/bitworld-logo.png"
                                alt="logo"
                                className="h-7 xl:h-9 hidden dark:block"
                            />
                        </Link>
                    </div>
                    ...
                    <div className='flex items-center gap-2 2xl:gap-6 flex-shrink-0 justify-end'>
                        <SearchModal
                        ...
                        {isAuthenticated && walletInfor && (
                            <button 
                                className='relative backdrop-blur-sm text-xs font-medium px-3 py-1.5 rounded-full transition-all duration-300 whitespace-nowrap flex items-center gap-1.5 overflow-hidden group text-theme-neutral-400 dark:text-neutral-100'
                                style={{
                                    background: mountedTheme && isDark
                            ...
                            >
                                ...
                                />
                                <span className="relative z-10">{t("myWallet")}</span>
                                <span className="relative z-10 opacity-90">{walletInfor.solana_balance} SOL</span>
                                <span className="relative z-10 opacity-90">{'$' + formatNumberWithSuffix3(walletInfor.solana_balance_usd)}</span>
                            </button>
                        )}
                        ...
                        {mounted ? (
                            <>
                                {!isAuthenticated && !phantomConnected ? (
                                    <button
                                        ...
                                        className="relative backdrop-blur-sm text-sm font-medium px-4 py-2 rounded-full transition-all duration-300 whitespace-nowrap flex items-center gap-1.5 overflow-hidden group"
                                        style={{
                                            background: mountedTheme && isDark
                                                ? 'linear-gradient(135deg, rgba(31, 193, 107, 0.2) 0%, rgba(31, 193, 107, 0.15) 100%)'
                                                : 'linear-gradient(135deg, rgba(31, 193, 107, 0.25) 0%, rgba(31, 193, 107, 0.2) 100%)',
                                    ...
                                    <DropdownMenu>
                                        <DropdownMenuTrigger asChild>
                                            <button 
                                                className="relative backdrop-blur-sm text-sm font-medium px-3 md:px-4 py-2 rounded-full transition-all duration-300 whitespace-nowrap flex items-center gap-1.5 outline-none overflow-hidden group"
                                                style={{
                                                    background: mountedTheme && isDark
                                                        ? 'linear-gradient(135deg, rgba(31, 193, 107, 0.2) 0%, rgba(31, 193, 107, 0.15) 100%)'
                                                        : 'linear-gradient(135deg, rgba(31, 193, 107, 0.25) 0%, rgba(31, 193, 107, 0.2) 100%)',
                                            ...
                                            >
                                                ...
                                                />
                                                <Wallet2 className="h-4 w-4 relative z-10" />
                                                <span className="text-xs hidden md:inline relative z-10">{truncateString(walletInfor?.solana_address, 12)}</span>
                            ...
                            <button
                                className="relative backdrop-blur-sm font-medium px-4 py-2 rounded-full transition-all duration-300 whitespace-nowrap overflow-hidden group"
                                style={{
                                    background: mountedTheme && isDark
                                        ? 'linear-gradient(135deg, rgba(31, 193, 107, 0.2) 0%, rgba(31, 193, 107, 0.15) 100%)'
                                        : 'linear-gradient(135deg, rgba(31, 193, 107, 0.25) 0%, rgba(31, 193, 107, 0.2) 100%)',
                            ...
                            >
                                ...
                                />
                                <span className="relative z-10 text-sm">{t('header.wallet.connecting')}</span>
                            </button>
                        )}
                        </div>
                    </div>
                    ...
                    <div className="lg:hidden fixed inset-0 z-50 bg-white dark:bg-black">
                        <div className=" h-full bg-[#1c8f52] backdrop-blur-md ">
                            <div className='dark:bg-theme-black-1/2 flex flex-col h-full overflow-y-auto'>
                                ...
                                {/* Mobile Navigation */}
                                <nav className="flex flex-col px-4 space-y-2 py-4">
                                    {listSidebar.map((item, index) => {
                                        ...
                                        const props = isExternalLink 
                                            ? { 
                                                ...
                                                rel: "noopener noreferrer",
                                                onClick: () => setIsMobileMenuOpen(false),
                                                className: `group relative px-4 py-3 rounded-lg text-base capitalize transition-all duration-300 flex items-center gap-3 ${
                                                    isActive 
                                                        ? 'text-theme-primary-500 font-semibold' 
                                    ...
                                    <Link
                                        ...
                                        onClick={() => setIsMobileMenuOpen(false)}
                                        className="hover:text-theme-primary-500 dark:text-theme-neutral-100 border-b border-white/50  text-theme-neutral-1000 md:dark:text-theme-neutral-300 capitalize transition-colors text-base py-2 flex items-center gap-3"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" fill="none">
                                        ...
                                        <div className="text-center text-theme-neutral-100 text-lg font-medium">
                                            {t('overview.universalAccount.receive')}
                                        </div>
                                    </Link>
                                    <Link
                                        ...
                                        onClick={() => setIsMobileMenuOpen(false)}
                                        className="hover:text-theme-primary-500 dark:text-theme-neutral-100 border-b border-white/50  text-theme-neutral-800 md:dark:text-theme-neutral-300 capitalize transition-colors text-base py-2 flex items-center gap-3"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" fill="none">
                                ...
                                <div className="p-4 space-y-4">
                                    <div className='flex items-center justify-evenly gap-4 mt-1 bg-theme-primary-500/40 rounded-md p-2'>
                                        <Moon
                                            ...
                                            style={isDark ? { color: "#fff" } : { color: "#bbc1cd" }}
                                        />
                                        <Sun
                                            className="cursor-pointer transition-colors"
                                            onClick={() => isDark && setTheme("light")}
                                            style={!isDark ? { color: "#f59e0b" } : { color: "#bbc1cd" }}
                                        />
                                    </div>
                                    {isAuthenticated && walletInfor && (
                                            ...
                                            <>
                                                {!isAuthenticated && !phantomConnected ? (
                                                    <button
                                                        ...
                                                        className="linear-gradient-light bg-theme-primary-500 text-black font-medium px-6 py-2 rounded-md transition-colors"
                                                    >
                                                        {t('connect')}
                                                    </button>
                                                ) : (
